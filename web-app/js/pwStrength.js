    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                ...
                progressbar.prop("aria-valuenow", "5");
                ...
                progressbar.addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progress-bar-success");
                progressbar.prop("aria-valuenow", "25");
                ...
                progressbar.prop("aria-valuenow", "50");
                ...
                progressbar.addClass("progress-bar-warning").removeClass("progress-bar-danger").removeClass("progress-bar-success");
                progressbar.prop("aria-valuenow", "75");
                ...
                progressbar.prop("aria-valuenow", "100");
        ...
        progressWidget = function () {
            return '<div class="progress"> <div class="progress-bar"role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><span class="sr-only"></span></div> </div>';
        },
