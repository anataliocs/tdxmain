            ...
            <div class="row">
                <div class="col-sm-8">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea ng-model="user.bio" class="form-control" placeholder="Short Bio"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="text-center">
                        ...
                        <br/>
                        <br/>
                        <img ng-src="{{getFBPictureUrl(FBUser.id)}}" ng-show="FBUser" title="{{getFBPictureUrl(FBUser.id)}}" class="img-thumbnail">
                    </div>
                    <br/>
