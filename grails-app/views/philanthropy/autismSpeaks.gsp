...
<title>Theta Delta Chi Rho Triton AA with Autism Speaks and Alpha Xi Delta</title>
...
<div class="container marketing">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            ...
            <h1>Alpha Xi Delta's Amaxing Challenge <span
                    class="text-muted">Xi Marks the Spot!</span></h1>
            <h4><span class="text-muted">Sunday April 19th, 2015 from 11AM - 2PM</span></h4><br/><br/>
            ...
            <p class="lead">
                ...
                collected it's a race back to the finish line to complete the puzzle and become the 2015 champions of Xi Marks the Spot!!
